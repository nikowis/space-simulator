...
public class FlatShader extends NakedShader {
    ...
    private static final String FRAGMENT_FILE = "/pl/nikowis/shaders/naked/flatFragmentShader.glsl";
    private static final String GEOMETRY_FILE = "/pl/nikowis/shaders/naked/flatGeometryShader.glsl";
